...
import {addTaskToTripForUser} from '../utils/service';
...
const AddTask = ({navigation, route}: any) => {
  const {relaod, setReload, tripID} = route.params;

  console.log(tripID, 'in add task');
  ...
  const handleSaveChanges = async () => {
    ...
    await addTaskToTripForUser(userState?.userId, tripID, payload)
      .then((res: any) => {
        console.log(res, 'res');
        handleBack();
        setReload(!relaod);
